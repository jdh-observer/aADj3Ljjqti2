...
```python caption="Piechart" jdh={"module": "object", "object": {"source": ["figure 1: Distribution of absolute frequencies by country on news reports on the *Maine*'s explosion"], "type": "image"}} tags=["hermeneutics", "figure-1"] widefigure=true
...
```python mpriewe={"figure": {"caption": "figure 3: Finland", "label": "figure 3: Finland"}} tags=["hermeneutics", "table-2"]
import pandas as pd
...
```python caption="Barchart" jdh={"module": "object", "object": {"source": ["figure 3: Distribution of opinions voiced about the *Maine*\u2019s explosion by country"], "type": "image"}} tags=["figure-3"] widefigure=true
import pandas as pd
import plotly.express as px
...
```python caption="Barchart" jdh={"module": "object", "object": {"source": ["figure 4: Distribution of speakers leaning towards attack hypothesis by country"], "type": "image"}} tags=["figure-4"] widefigure=true
import pandas as pd
import plotly.express as px
...
```python caption="Barchart" jdh={"module": "object", "object": {"source": ["figure 5: Distribution of speakers leaning towards accident hypothesis by country"], "type": "image"}} tags=["figure-5"] widefigure=true
import pandas as pd
import plotly.express as px
